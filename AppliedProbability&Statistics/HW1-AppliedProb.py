...
1--> Write a small program to compute the average value of the dataset and the median.
2--> Construct a frequency distribution of the dataset using Sturges's rule for the number of
classes and rounding up the obtained expression.
3--> Draw histogram of the frequency distribution and the frequency polygon.
4--> Draw histogram of the cumulative frequency distribution and the ogive (less than type).
5--> Illustrate how you would find the median of the frequency distribution you constructed.
...
6--> Compute the arithmetic average of the frequency distribution using class marks and 
...
print("Arithmetic Mean of Values: ",arithmeticMean)
